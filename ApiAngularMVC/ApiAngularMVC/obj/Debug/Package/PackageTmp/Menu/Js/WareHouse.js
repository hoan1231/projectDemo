...
app.controller("WareHouse1Controller", function ($scope, CatTypeService, CatMaterialService, CompanyService, CategorysService, CatManufacturerService) {
    $scope.nameCat = ""; $scope.changeData = true; $scope.Company = "";
    $scope.lsCategory = [];
    ...
    CompanyService.getCompanyLogin().then(function (data) {
        $scope.Company = data;
    });
